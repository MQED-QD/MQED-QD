...
PARAM_FILE="${PARAM_FILE:-${REPO_ROOT}/mqed/disorder/nn_sweep_params.tsv}"
JOBARRAY_SCRIPT="${JOBARRAY_SCRIPT:-${REPO_ROOT}/mqed/disorder/jobarray.sh}"
...
echo "Submitting ${TASK_COUNT} NN sweep tasks using ${PARAM_FILE}"
